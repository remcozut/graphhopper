...
public class EncodingManager implements EncodedValueLookup {
    ...
    public static final long NODE_NAME_ENCODING_BIT = 1024;
...
//    private final Map<EncodedValue, TagParser> sharedEncodedValueMap = new LinkedHashMap<>();
    ...
    public static class Builder {
         ...
         * createEncodedValues.
         */
        public Builder add(com.graphhopper.routing.util.parsers.TagParser tagParser) {
...
*/
    ...
    public enum Access {
        WAY, FERRY, OTHER, RESTRICTED, CAN_SKIP;
        ...
        public boolean isRestricted() { return this.ordinal() == RESTRICTED.ordinal(); }
    ...
    public void addNodeRefEncFromNodeFlags(IntsRef edgeFlags, int nodeId) {
        for (AbstractFlagEncoder edgeEncoder : edgeEncoders) {

            edgeEncoder.getNodeNameEnc().setInt(false, edgeFlags, nodeId);
        }
    }
