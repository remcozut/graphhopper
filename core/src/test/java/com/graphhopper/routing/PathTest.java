...
public class PathTest {
    ...
    public void testFindInstruction() {
        ...
        assertEquals(Instruction.RIGHT, nextInstr1.getSign());

        Instruction nextInstr2 = il.find(5.0, 0.004, 1000);
        assertEquals(Instruction.LEFT, nextInstr2.getSign());

        Instruction nextInstr3 = il.find(9.99, 0.503, 1000);
        assertEquals(Instruction.SHARP_LEFT, nextInstr3.getSign());
