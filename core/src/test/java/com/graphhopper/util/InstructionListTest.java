...
public class InstructionListTest {
    ...
    public void testCreateGPXCorrectFormattingSmallNumbers() {
        ...
        Instruction instruction = new Instruction(0, TurnType.TURN, "do it", null, pl);
    ...
    public void testCreateGPX() {
        ...
        instructions.add(new Instruction(Instruction.STRAIGHT, TurnType.CONTINUE, "temp", ea, pl).setDistance(240).setTime(15000));
